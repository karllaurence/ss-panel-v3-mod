...
class Job
{
    ...
    public static function CheckJob()
    {
        ...
        $latest_content = file_get_contents("https://github.com/karllaurence/ss-panel-v3-mod/raw/fly/bootstrap.php");
            ...
            if ($newmd5 == $oldmd5) {
                ...
                if (!file_exists(BASE_PATH."/storage/update.md5")) {
                    foreach ($adminUser as $user) {
                        ...
                        $to = $user->email;
                        $text = "管理员您好，系统发现有了新版本，您可以到 <a href=\"https://github.com/karllaurence/ss-panel-v3-mod/wiki/%E6%9B%B4%E6%96%B0%E6%97%A5%E5%BF%97\">https://github.com/karllaurence/ss-panel-v3-mod/wiki/%E6%9B%B4%E6%96%B0%E6%97%A5%E5%BF%97</a> 按照步骤进行升级。" ;
                        try {
                            Mail::send($to, $subject, 'news/warn.tpl', [
                                "user" => $user,"text" => $text
                            ], [
