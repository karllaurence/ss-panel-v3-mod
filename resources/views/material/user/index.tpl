											...
											<div class="tab-content">
												...
												<div class="tab-pane fade {if !$ssr_prefer}active in{/if}" id="all_ss">
													...
													<div class="tab-pane fade active in" id="all_ss_info">
														...
														{else}
														<dl class="dl-horizontal">
															<p>您好，您目前的加密方式、混淆或者协议设置不支持 Shadowsocks 普通端口的连接，请在「资料编辑」编辑至支持 Shadowsocks 的配置。</p>
														</dl>
														{/if}
													</div>
													...
													<div class="tab-pane fade" id="all_ss_mac">
														<p><a href="/downloads/SS-macOS.zip">下载</a>，安装，然后下载<a href="/user/getpcconf?is_mu=0&is_ss=1">这个（普通端口）</a>，运行程序，小飞机上右键 服务器列表 子菜单 的 “导入服务器配置文件...” 导入这个文件，然后选择一个合适的服务器，更新一下PAC，然后开启系统代理即可上网。</p>
													...
													<div class="tab-pane fade" id="all_ss_ios">
														<p>推荐下载 <a href="https://itunes.apple.com/hk/app/shadowrocket/id932747118?mt=8">Shadowrocket</a>，然后在 Safari 中点击<a href="{$ss_url_all}">这个（普通端口）</a>，然后点击确定，就可以批量添加节点。</p>
														<p>或者可以下载 <a href="https://itunes.apple.com/hk/app/surge-3-web-developer-tool/id1329879957?mt=8">Surge</a>，然后下载<a href="/link/{$ios_token}?is_ss=1">这个（普通端口）</a>，导入到 Surge 中，然后就可以随意切换服务器上网了。</p>
													</div>
													<div class="tab-pane fade" id="all_ss_android">
														<p><a href="/downloads/SS-Android.apk">下载</a>，再<a href="/downloads/SS-Android-Obfs.apk">下载</a>，然后安装，然后在手机上点击<a class="copy-text" data-clipboard-text="{$ss_url_all}">这个链接（普通端口）</a>复制到剪贴板，打开 Shadowsocks 客户端，选择从剪贴板导入，然后选择一个节点，设置一下路由为绕过大陆，点击飞机就可以上网了。</p>
													</div>
													<div class="tab-pane fade" id="all_ss_router">
														<p>路由器 刷入<a href="http://www.right.com.cn/forum/thread-161324-1-1.html">这个固件</a>，然后 SSH 登陆路由器，执行以下命令（导入普通端口）<br>
														<code>wget -O- {$baseUrl}/link/{$router_token}?is_ss=1 | bash && echo -e "\n0 */3 * * * wget -O- {$baseUrl}/link/{$router_token}?is_ss=1 | bash\n">> /etc/storage/cron/crontabs/admin && killall crond && crond </code></p>
													</div>
												</div>
											</div>
										</div>
