                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-10 col-md-push-1">
                          ...
                          <p style="color: red">如果您未能收到邮件，请查看'垃圾邮件'中是否存在，并将<a>support@mimemi.me</a>加入白名单</p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <p class="text-right"><button class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal" type="button" id="cancel">我不同意</button><button class="btn btn-flat btn-brand-accent waves-attach waves-effect" data-dismiss="modal" id="reg" type="button">同意</button></p>
