				...
				<div class="row row-grid justify-content-between align-items-center mt-lg">
						<div class="col-lg-12">
							<div class="card card-lift shadow border-0">
								<div class="card-body">
								<p style="font-weight: bold !important">系统中您所有的中转规则。</p>
								<p style="font-weight: bold !important">在这里，您可以设置您的中转规则，从而将数据从一个服务器重定向到另外一个服务器。</p>
								<p style="font-weight: bold !important">优先级越大，代表其在多个符合条件的规则并存时会被优先采用，当优先级一致时，先添加的规则会被采用。</p>
								<p style="font-weight: bold !important">对某个节点不设置中转时，这个节点就可以当作一个普通的节点来做代理使用。</p>
								</div>
							</div>
						</div>		
					</div>
