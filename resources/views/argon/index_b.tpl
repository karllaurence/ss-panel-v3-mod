					  	...
					  	<nav>
							...
							<ul>
                               <li><a href="#1">简介</a></li>
								...
								<li><a href="//mimemi.me/code">邀请码注册</a></li>
                              	<li><a href="#4">联系</a></li>
								<li><a href="#5">下载</a></li>
              ...
              <!--首页结束-->
					<div id="main">
                      ...
                      <p>
						...
						<li>这里是一堵围墙</li>
						<li>一堵可以打开你心结的围墙</li>
						<li>当你努力攀爬出去的时候，或许你就发现了世界的美好。</li>
						</ul>
						<p></p></article>
                     <!--标签4开始-->
                      <article id="4">
								...
								<ul class="icons">
                                   <p>请加入下方我们的TG群组:</p>
                                    <li>
                                      <a target="_blank" href="https://t.me/LKFWorld" class="icon fa-telegram">
                      ...
                      <!--标签5开始-->
							...
							<ul>
							  ...
							  <li><a href="/downloads/Shadowrocket_2.1.12.ipa" class="icon fa-apple"><span class="label">iOS</span> iOS</a></li>
                              <li><a href="/ssr-download/SSTap.7z" class="icon fa-gamepad"><span class="label">Windows游戏专用</span> Win游戏专用</a></li>
                     ...
                     <!-- 版权底部 -->
                      <footer id="footer">
                   <p class="copyright">&copy;2016-2018 {$config["appName"]}</p>
                      </footer>
              <!-- 版权结束 -->
			 </div>
                <!-- BG -->
